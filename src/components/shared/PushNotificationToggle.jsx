    ...
    return (
        <div className="fixed bottom-6 right-6 z-[100] animate-in slide-in-from-bottom duration-500">
            <button
                onClick={handleClick}
                disabled={loading || isDenied}
                className={`group flex items-center gap-3 px-6 py-4 rounded-[2rem] border backdrop-blur-xl shadow-2xl transition-all active:scale-95 ${isSubscribed
            ...
            {isDenied && (
                <div className="absolute bottom-full right-0 mb-4 w-64 bg-yellow-500/10 border border-yellow-500/20 backdrop-blur-md p-4 rounded-2xl animate-in zoom-in duration-300">
            ...
            {error && (
                <div className="absolute bottom-full right-0 mb-4 w-64 bg-red-500/10 border border-red-500/20 backdrop-blur-md p-4 rounded-2xl animate-in zoom-in duration-300">
